...
def make():
    ...
    <p class="muted">FOLIO / ПЕРВАЯ КНИГА</p>
    <h1>Всё начинается<br/>с одной страницы.</h1>
    <p>Эта небольшая книга поможет проверить Folio: открытие,
    поиск по тексту, закладки и печать.</p>
    <h2>Книги — рядом</h2>
    <p>Добавьте свои PDF, DjVu, EPUB или FB2. Folio запоминает,
    ...
    <p class="muted">Демонстрационный текст создан для Folio. CC0.</p>
    </body></html>'''
    ...
    pdf.set_metadata({'title':'Добро пожаловать в Folio','author':'Folio'})
    ...
    <description><title-info><genre>reference</genre><author><first-name>Folio</first-name><last-name>Demo</last-name></author>
    <book-title>Проверка FB2</book-title><lang>ru</lang></title-info></description>
    <body><title><p>Книга в Folio</p></title><section><title><p>Первая глава</p></title>
    ...
    (SAMPLES/'Welcome.txt').write_text('Folio\n\nПривет, читатель!\nЗелёная закладка.\nЭто TXT в UTF-8.\n',encoding='utf-8')
    with zipfile.ZipFile(SAMPLES/'Welcome.epub','w') as z:
        ...
        z.writestr('OEBPS/book.opf','''<?xml version="1.0" encoding="utf-8"?><package xmlns="http://www.idpf.org/2007/opf" version="2.0" unique-identifier="id"><metadata xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:title>Книга EPUB в Folio</dc:title><dc:language>ru</dc:language><dc:identifier id="id">folio-demo</dc:identifier></metadata><manifest><item id="c1" href="chapter.xhtml" media-type="application/xhtml+xml"/><item id="ncx" href="toc.ncx" media-type="application/x-dtbncx+xml"/></manifest><spine toc="ncx"><itemref idref="c1"/></spine></package>''')
        z.writestr('OEBPS/chapter.xhtml','''<?xml version="1.0" encoding="utf-8"?><html xmlns="http://www.w3.org/1999/xhtml"><head><title>Folio</title></head><body><h1>Folio — проверка EPUB</h1><p>Привет, читатель. Зелёная закладка.</p><p>Книги разных форматов в одном приложении.</p></body></html>''')
        z.writestr('OEBPS/toc.ncx','''<?xml version="1.0" encoding="utf-8"?><ncx xmlns="http://www.daisy.org/z3986/2005/ncx/" version="2005-1"><head><meta name="dtb:uid" content="folio-demo"/></head><docTitle><text>Folio</text></docTitle><navMap><navPoint id="c1" playOrder="1"><navLabel><text>Первая глава</text></navLabel><content src="chapter.xhtml"/></navPoint></navMap></ncx>''')
