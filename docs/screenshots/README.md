...
Upload the current Lexumi screenshots to this directory using these exact filenames:
...
- `print-preview.png` — Lexumi print preview with custom range and pages-per-sheet controls
